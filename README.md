Data Cleaning Using Python (Cricket Dataset)

This project focuses on cleaning and analyzing a messy cricket dataset using Python (Pandas & NumPy). The goal was to transform raw, inconsistent data into a structured format suitable for analysis and business insights.

🔧 Technical Learnings
Renaming Columns: Learned to rename multiple columns for better readability and consistency.
Handling Missing Values: Replaced false null values (like '', 'NA', 'null') with proper NaN using NumPy.
Duplicate Handling: Identified and removed duplicate records to ensure data accuracy.
